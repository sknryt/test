        ...
        with col2:
            if members:
                ...
                if input_mode == "一覧から選択":
                    name = st.selectbox("メンバー", members, label_visibility="collapsed")
                else:
                    name = st.text_input("名前を入力", placeholder="山田 太郎", label_visibility="collapsed")
            else:
                name = st.text_input("名前", placeholder="山田 太郎")
